...
### Usage:
```
git clone https://github.com/Kritlesh/instaphanton
cd instaphanton
chmod +x instaphanton.sh
sudo ./instaphanton.sh
```
...
<noscript><a href="https://liberapay.com/theKritt_on_top/donate"><img alt="Donate using Liberapay" src="https://liberapay.com/assets/widgets/donate.svg"></a></noscript>
